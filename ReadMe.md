...
utsavMongoDB: create a Readme.md file 

Workspace: # Trip Planner

## Overview

Trip Planner is a web application designed to help users plan their trips efficiently. It leverages MongoDB for data storage and Amazon Bedrock for embedding and vector search capabilities. The application provides a user-friendly interface to input trip details and generates a detailed itinerary based on the provided information.
